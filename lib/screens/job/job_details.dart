...
import 'package:job_quest/utils/global_methods.dart';
import 'package:job_quest/utils/global_variables.dart';
import 'package:job_quest/widgets/comments_widget.dart';
...
class _JobDetailsScreenState extends State<JobDetailsScreen> {
  ...
  applyForJob() async {
    ...
    await FirebaseFirestore.instance
        ...
        .update({
      'appliedJobs': FieldValue.arrayUnion([widget.job_id])
    });
    ////////////
  }
